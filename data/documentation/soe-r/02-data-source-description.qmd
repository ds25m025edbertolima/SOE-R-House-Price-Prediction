...
This data dictionary is a prerequisite for data preparation and serves as the reference for understanding the relational structure and field definitions necessary for proper data integration and feature engineering.

## Data Sources

- **Tax and Assessment System**: Maintains current tax account information
- **Appraisal System**: Maintains detailed property appraisals and improvements
- **Public Records**: Available through Pierce County Public Records Request Center

::: {.callout-note}
RCW 42.56.070(9) may restrict the release of taxpayer names and mailing addresses in certain circumstances. Contact the Pierce County Public Records Request Center for additional information.
:::
...
Field names in **bold** represent primary key(s).
:::
...
::: {.callout-warning}
RCW 42.56.070(9) may restrict the release of taxpayer names and mailing addresses in certain circumstances. Please contact the Pierce County Public Records Request Center to obtain additional information and/or initiate a request for the taxpayer table.
:::
