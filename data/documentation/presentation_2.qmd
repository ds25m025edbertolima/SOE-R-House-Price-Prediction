...
![Distribution of squarefoot price](diagrams/eda/price_per_squarefeet.png)
...
| Model | RMSE | MAE | R_squared | MAPE |
|:---|:---|:---|:---|:---|
| Mean Model | 315682.7 | 185274.24 | NA | 64.25098 |
| Linear Regression | 225930.5 | 108037.99 | 0.4654660 | 33.11315 |
| Ridge Regression | 203716.4 | 101554.28 | 0.6456080 | 33.25099 |
| LASSO Regression | 183186.9 | 91825.22 | 0.6843780 | 30.28490 |
| Elastic Net Regression | 188257.1 | 93482.68 | 0.6780421 | 30.58247 |
:::
...
| **+sale_year** | 5 | `r metrics_table[2, "RMSE"]` | `r metrics_table[2, "Rsquared"]` | `r metrics_table[2, "MAE"]` |
| **+sale_year+quality** | 5 | `r metrics_table[3, "RMSE"]` | `r metrics_table[3, "Rsquared"]` | `r metrics_table[3, "MAE"]` |
| **full** | 5 | `r metrics_table[4, "RMSE"]` | `r metrics_table[4, "Rsquared"]` | `r metrics_table[4, "MAE"]` |
