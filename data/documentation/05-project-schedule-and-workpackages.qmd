...
gantt
    ...
    EDA & Features     :wp3, 2026-05-30, 9d
...
: Timeline showing all project phases, milestones, and critical path tasks from May 13 to June 24, 2026. 
:::
...
![Project Gantt Chart showing all work packages and critical path tasks.](diagrams/gantt.png){#fig-gantt-timeline}
...
2.  Create Git repository (private, shared with lecturer)
3.  Set up Supabase database connection
4.  Initialize Kanban board (Backlog/To Do/Doing/Testing/Done)
5.  Configure R development environment
...
**Duration**: 20–26 May \| **Status**: Partially complete
...
: Work package interdependencies and blocking relationships defining the critical path. {#tbl-dependencies}
...
: Project milestones, scheduled events, and corresponding deliverables. {#tbl-milestones}

------------------------------------------------------------------------

## Weekly Status Checklist

- [x] **Week 1 (13–19.05)**: WP0 setup complete
- [x] **Week 2 (20–26.05)**: WP1 data integration done, Proposal prepared
- [x] **Week 3 (27.05–02.06)**: WP2 data cleaning complete, WP3 started
- [x] **Week 4 (03–09.06)**: WP3 features complete, WP4 preprocessing ready
- [x] **Week 5 (10–16.06)**: WP5 all 5 models trained and validated
- [x] **Week 6 (17–23.06)**: WP6 best model selected, WP7 Shiny App deployed
- [x] **Week 7 (24.06)**: Final presentation & report submitted